...
if(isset($_POST["btnsave"]))
{
  ...
  $ration=$_POST["txtration"];
  $members=$_POST["txtmember"];
	$path=$_FILES["filephoto"]["tmp_name"];
	move_uploaded_file($path,"../Assets/Files/Photo/".$photo);
	
	
	$insQry="insert into tbl_user(user_name,user_contact,user_address,user_email,place_id,user_photo,user_ration,members_no,user_password)values('".$name."','".$contact."','".$address."','".$email."','".$place_id."','".$photo."','".$ration."','".$members ."','".$password."')";
	//echo $insQry;	
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
  <table width="200" border="1" align="center">
    ...
    <tr>
      <td>Ration no</td>
      <td><label for="txt_ration"></label>
      <input type="number" name="txtration" id="txt_ration" autocomplete="off" required/></td>
    </tr>
    <tr>
      <td>members</td>
      <td><label for="txt_members"></label>
      <input type="number" name="txtmember" id="txt_members" autocomplete="off" required/></td>
    </tr>
