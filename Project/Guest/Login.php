...
if(isset($_POST["btnlogin"]))
{
	...
	$selQry1 = "select * from tbl_employee where employee_email ='".$email."' and employee_password='".$password."'";
	...
	{
		$_SESSION["kid"]=$row1["employee_id"];
		$_SESSION["kname"]=$row1["employee_name"];
