                                ...
                                <div class="card border-secondary">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title text-danger" align="center">
                                            Price : <?php
                                           $selCheck="SELECT * FROM tbl_booking b INNER JOIN tbl_cart c on b.booking_id=c.booking_id where MONTH(b.booking_date)=MONTH(CURDATE())  and c.cart_status=1 and c.product_id=".$rowS["product_id"]." and b.user_id=".$_SESSION['uid'];
                                            $resCheck=$Conn->query($selCheck);
                                            if($resCheck->num_rows>0){
                                                $rate=$rowS['product_price'];
                                                echo $rowS['product_price'];
                                            }
                                            else{
                                                $rate=$rowS['product_subsidy'];
                                                echo $rowS["product_subsidy"]; 
                                            }
                                            ?>/- KG
                                        </h4>
                                        <p align="center">
                                            <?php echo $rowS["product_details"]; ?><br>
                                        </p>
                                        <?php
										   ...
										   ?>
                                            ...
                                            <?php
                                                ...
                                                if ($stock > 0) {
                                        ?>
                                        <a href="javascript:void(0)" onclick="addCart('<?php echo $rowS["product_id"]; ?>','<?php echo $rate; ?>')" class="btn btn-success btn-block">Add to Cart</a>
                                        <?php
                                        } else if ($stock == 0) {
                                        ?>
