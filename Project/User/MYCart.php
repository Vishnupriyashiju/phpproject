        ...
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
            ...
            <div class="product">
                ...
                <div class="product-price "	><?php
                                           $selCheck="SELECT * FROM tbl_booking b INNER JOIN tbl_cart c on b.booking_id=c.booking_id where MONTH(b.booking_date)=MONTH(CURDATE()) and c.cart_status=1 and  c.product_id=".$rowpr["product_id"]." and b.user_id=".$_SESSION['uid'];
                                            ...
                                            if($resCheck->num_rows>0){
                                                ...
                                                $pr=$rowpr['product_subsidy'];
                                                echo $rowpr["product_subsidy"]; 
                                            }
                                            ?></div>
