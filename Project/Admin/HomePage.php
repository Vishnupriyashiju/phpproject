                                            ...
                                            <div class="quick_activity_wrap">
                                                <div class="single_quick_activity d-flex">
                                                    ...
                                                    <div class="count_content">
                                                        ...
                                                        <?php
														$sel = "select count(employee_id) as id from tbl_employee";
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Files/Photo/<?php echo $data1["employee_photo"] ?>" alt="">
                                        </div>
                                        <h4><?php echo $data1["employee_name"] ?></h4>
                                        <p><?php echo $data1["employee_contact"] ?></p>
                                    </div>
                                    <?php
                                        }
                                    ?>
